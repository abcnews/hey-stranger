...
module.exports = ({ isUnavailable, title, bylineHTML, infoSource, infoSourceURL, standfirst }) => (
  <header className={styles.root}>
    <div className={styles.title} role="heading" aria-level="1">
      <span>{title}</span>
      <svg role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 656 72" preserveAspectRatio="xMidYMax">
      ...
      <svg role="presentation" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 518 24" preserveAspectRatio="xMidYMin">
...
module.exports.displayName = 'Meta';
